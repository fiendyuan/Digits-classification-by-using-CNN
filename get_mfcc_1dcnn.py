...
def MFCC(file):
    ...
    mfcc_data = librosa.feature.mfcc(y=y, sr=sr, window='hamming', n_mfcc=20)
    X = np.zeros((720, 1), dtype=np.float)
    ...
    return X
b = MFCC('voice/voices/0_my_2.wav')
print(b)
print(b.shape)
...
#
#     X = np.zeros((22500, 1), dtype=np.float)
...
#     print(a.shape)
# print(max(list))
# b = get('voices/voices/0_my_0.wav')
# print(b)
#
# import os
# list= []
